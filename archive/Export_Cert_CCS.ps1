...
# Updated to use defined PFX password, get certificate file names from IIS SNI bindings,
...
try {
    ...
    Write-Log -Message "Successfully loaded WebAdministration module" -EventId 1017
} catch {
    Write-Log -Message "Failed to load WebAdministration module: $($_.Exception.Message)" -Level "ERROR" -EventId 1018
    throw
}
